...
<body>
	<div id="wrap">
		<h1 class="n-hidden">로그인 테스트 화면</h1>
		...
		<div class="form-area">
			...
			<div class="loginbox">
				<form name="loginForm" action="">
					...
					<span class="id"> <input type="text" name="id" class="inputbox" placeholder="아이디를 입력해주세요">
					</span> <span class="pw"> <input type="text" name="password" class="inputbox" placeholder="비밀번호를 입력해주세요">
					</span> <span class="submit submitBox"> <input type="submit" value="로그인">
					</span>

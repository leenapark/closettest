	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="main">
				<div id="main-top">
					<ul>
						<li class="page-follow following-active"><a target="_self" href="${pageContext.request.contextPath}/user/following2">팔로잉</a></li>
						<li class="page-follow"><a target="_self" href="${pageContext.request.contextPath}/user/followers2">팔로워</a></li>
					</ul>
				</div>
